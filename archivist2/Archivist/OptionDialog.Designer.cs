namespace Archivist
{
	partial class OptionDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.cbShowImagesLibrary.Size = new System.Drawing.Size(317, 17);
			this.cbShowImagesLibrary.TabIndex = 4;
			this.cbShowImagesLibrary.Text = "Show Images in Library (Restart required, Slows down startup)";
			...
			this.cbShowImagesDeck.Size = new System.Drawing.Size(261, 17);
			this.cbShowImagesDeck.TabIndex = 3;
			this.cbShowImagesDeck.Text = "Show Images in Deck (Newly opened decks only)";
